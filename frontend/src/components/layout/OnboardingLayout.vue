<template>
  <div class="min-h-screen flex relative">
    ...
    <div class="w-full lg:w-1/2 bg-white flex flex-col relative z-20">
      ...
      <div class="px-8 py-6 lg:px-12 flex justify-center"> <div class="flex items-center gap-2">
          <img :src="logo" alt="VisitorKu" class="h-12" />
        </div>
      </div>

      <div class="flex-1 flex flex-col justify-start pt-[39px] px-8 lg:px-12 xl:px-20 pb-8">
        <slot />
      </div>

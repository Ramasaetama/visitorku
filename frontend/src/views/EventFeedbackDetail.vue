      ...
      <div class="p-8 flex-1 flex flex-col overflow-y-auto">
        ...
        <div class="flex items-center justify-between mb-8">
          <div class="flex items-center gap-3">
            <button
              @click="goBack"
              class="w-8 h-8 flex items-center justify-center bg-[#FEF4E3] text-[#F7941D] rounded-lg hover:bg-[#F7941D] hover:text-white transition-colors focus:outline-none"
            >
          ...
          <nav class="flex items-center gap-1.5 text-sm text-gray-400">
            ...
            <button @click="goBack" class="hover:text-[#F7941D] transition-colors">Event Visitor</button>
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
            <span class="text-[#F7941D] font-medium">Detail</span>
          </nav>
        </div>
        ...
        <div v-else-if="detail" class="space-y-8">
          ...
          <div>
            ...
            <div v-if="get(['satisfaction']) || get(['notes','feedback'])" class="flex items-center gap-6">
              ...
              <!-- Notes -->
              <div>
                <p class="text-[13px] font-semibold text-gray-400 mb-1">Notes</p>
                <p class="text-[15px] font-semibold text-[#F7941D]">
                  {{ get(['notes','feedback']) ?? '-' }}
                </p>
              </div>
            </div>

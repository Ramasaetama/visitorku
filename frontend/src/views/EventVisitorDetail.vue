  ...
  <div class="bg-white rounded-2xl shadow-sm h-full flex flex-col">
    <div class="p-8 flex-1 flex flex-col overflow-y-auto">
      ...
      <div class="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
        ...
        <!-- Breadcrumb -->
        <nav class="hidden md:flex items-center gap-1.5 text-[13px] text-gray-400">
          <span class="hover:text-gray-600 cursor-pointer" @click="router.push('/dashboard')">
            <svg class="w-3.5 h-3.5 inline -mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 9.75L12 3l9 6.75V21a.75.75 0 01-.75.75H15.75a.75.75 0 01-.75-.75v-4.5h-6V21a.75.75 0 01-.75.75H3.75A.75.75 0 013 21V9.75z"/></svg>
            Dashboard
          </span>
          ...
          <span class="hover:text-gray-600 cursor-pointer" @click="router.push('/event')">Event</span>
          <svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
          <span class="hover:text-gray-600 cursor-pointer" @click="goBack">Event Visitor</span>
          <svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
